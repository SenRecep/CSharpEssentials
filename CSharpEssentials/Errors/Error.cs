...
public readonly record struct Error : IError
{
    ...
    private readonly byte _numericType;
    ...
    /// </summary>
    public readonly string Code => _code;
    ...
    /// Gets the error type.
    /// </summary>
    public readonly ErrorType Type => _type;

    /// <summary>
    /// Gets the numeric value of the type.
    /// </summary>
    public readonly int NumericType => _numericType;

    /// <summary>
    /// Gets the metadata.
    /// </summary>
    public readonly ErrorMetadata? Metadata => _metadata;
    ...
    public override int GetHashCode()
    {
        ...
        if (Metadata is null) return hashCode.ToHashCode();
