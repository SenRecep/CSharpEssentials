...
public readonly partial record struct Result
{
    ...
    public async Task<Result> ElseAsync(Func<Error[], Task<IEnumerable<Error>>> onFailure, CancellationToken cancellationToken = default)
    {
        ...
        var errors = await onFailure(Errors).WithCancellation(cancellationToken);
...
{
    /// <summary>
    /// Awaits a Task<Result> and, if the operation failed, executes a function to generate a single error.
    /// </summary>
    ...
    /// <summary>
    /// Awaits a Task<Result> and, if the operation failed, executes a function to generate multiple errors.
    /// </summary>
    /// <param name="task">The Task producing a Result.</param>
    ...
    /// <summary>
    /// Awaits a Task<Result> and, if the operation failed, replaces the current errors with a specified error.
    /// </summary>
    /// <param name="task">The Task producing a Result.</param>
    ...
    /// <summary>
    /// Awaits a Task<Result> and, if the operation failed, executes an asynchronous function to generate a single error.
    /// </summary>
    /// <param name="task">The Task producing a Result.</param>
    ...
    /// <summary>
    /// Awaits a Task<Result> and, if the operation failed, executes an asynchronous function to generate multiple errors.
    /// </summary>
    /// <param name="task">The Task producing a Result.</param>
    ...
    /// <summary>
    /// Awaits a Task<Result> and, if the operation failed, replaces the current errors with a specified asynchronous error.
    /// </summary>
    /// <param name="task">The Task producing a Result.</param>
