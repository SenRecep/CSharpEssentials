...
public readonly partial record struct Result
{
    ...
    public async Task<Result> ThenAsync(Func<Task<Result>> onSuccess, CancellationToken cancellationToken)
    {
        if (IsFailure)
            return this;
    ...
    public async Task<Result> ThenDoAsync(Func<Task> action, CancellationToken cancellationToken)
    {
        if (IsFailure)
            return this;
