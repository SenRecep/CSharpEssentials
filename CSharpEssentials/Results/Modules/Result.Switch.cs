...
public readonly partial record struct Result
{
    ...
    public async Task SwitchAsync(Func<Task> onSuccess, Func<Error[], Task> onFailure, CancellationToken cancellationToken)
    {
        if (IsFailure)
        {
    ...
    /// <param name="cancellationToken">A token to observe for cancellation requests.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public async Task SwitchFirstAsync(Func<Task> onSuccess, Func<Error, Task> onFirstError, CancellationToken cancellationToken)
    {
        if (IsFailure)
        {
    ...
    /// <param name="cancellationToken">A token to observe for cancellation requests.</param>
    /// <returns>A task representing the asynchronous operation.</returns>
    public async Task SwitchLastAsync(Func<Task> onSuccess, Func<Error, Task> onLastError, CancellationToken cancellationToken)
    {
        if (IsFailure)
        {
