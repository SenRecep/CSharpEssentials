...
public interface IResult<TValue> : IResultBase
{
    ...
    /// </summary>
    public new readonly static IEqualityComparer<IResult<TValue>> Comparer = new ResultComparer<TValue>();
    /// <summary>
    ...
    /// <typeparam name="T">The type of the result value.</typeparam>
    /// <param name="onSuccess">A function that takes the value and returns a result value.</param>
    /// <param name="onFirstError">A function that takes the first error and returns a result value.</returns>
