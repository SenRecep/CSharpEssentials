...
public static class StringExtensions
{
    ...
    private static string ConvertCase(string input, CaseType caseType)
    {
        ...
        bool insertSeparator = caseType != CaseType.Camel && caseType != CaseType.UnderscoreCamel;

        int extraSize = caseType == CaseType.UnderscoreCamel ? _one : _zero;
        var spanSize = (caseType is CaseType.Pascal or CaseType.Camel or CaseType.UnderscoreCamel)
    ...
    private static char GetCharacterCase(char c, CaseType caseType, bool insertSeparator, bool isFirstCharacter)
    {
        return caseType switch
        {
            ...
            _ => insertSeparator ? char.ToUpperInvariant(c) : char.ToLowerInvariant(c)
        };
    }
