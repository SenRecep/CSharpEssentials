...
public static class GeneralExtensions
{
    ...
    public static bool IsTrue(this bool value) => value is true;
    public static bool IsFalse(this bool value) => value is false;
    ...
    public static string ToStringFromGuid(this Guid guid) => Guider.ToStringFromGuid(guid);
    ...
    public static Maybe<DateTime> MsToDateTime(this long? value, DateTime? defaultValue = null) =>
       value.HasValue ? value.MsToDateTime() : (defaultValue.HasValue ? defaultValue.Value : Maybe.None);
    ...
    {
        var groupValue = type.ToInt32(null) / group * group;
