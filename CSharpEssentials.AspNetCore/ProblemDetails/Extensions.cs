...
{
    private static Action<ProblemDetails, HttpContext>? _problemDetailsEnhancer = null;
    /// <summary>
        ...
        Action<ProblemDetails, HttpContext>? configure = null)
    {
        ...
        services.AddProblemDetails(options =>
       {
           ...
           {
               context.ProblemDetails.AddHttpContextDetails(context.HttpContext);
           };
       });
        return services;
    }
    ...
    {
        var problemDetails = errors.ToProblemDetails(extensions, statusCode);
    ...
    {
        var metadata = extensions.IsNotNull() ? new ErrorMetadata(extensions) : ErrorMetadata.CreateEmpty();
        var error = errors.MaxBy(e => e.Type.ToHttpStatusCode());
    ...
    {
        if (httpContext is null) return problemDetails;
